...
import { useHitModal } from "@/presentation/hooks/modal/use-hit-modal";
...
export const HitModal = () => {
  const isOpen = useHitModal((state) => state.isOpen);
  const onClose = useHitModal((state) => state.onClose);
        ...
        >
          <DialogHeader className="relative w-full h-full flex flex-col items-center justify-between">
            ...
            <div className="relative w-full flex items-center justify-center">
              ...
              <div className="w-full h-[2px] filter blur-sm bg-green-400 shadow-[0_0_8px_1px_rgba(0,255,0,0.5)]" />
              <div className="flex items-center justify-center mx-4">
                <img
                  src="/hand-option-modal-deco.png"
                  alt="Decoration"
              ...
              >
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <div className="relative px-4 pb-1">
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-300 via-green-500 to-green-300 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
                      Hit!
                    </span>
                    <div className="absolute -inset-1 bg-gradient-to-r from-green-400/50 via-green-300/50 to-green-400/50 blur-lg -z-10" />
