        ...
        <main className="min-h-screen pt-20">
            ...
            <div className="min-h-full flex flex-col items-center justify-center md:justify-start text-center gap-y-4 flex-1 px-6 pb-10">
                <div className="max-w-3xl space-y-4">
                    <div className="relative inline-block z-0 w-full -space-y-6">
                        <h1
                            className="
                                text-5xl md:text-6xl xl:text-7xl text-black font-['Dela_Gothic_One'] [-webkit-text-stroke:2px_#fff462]
                                before:block before:content-[''] before:absolute before:w-full
                                before:h-10 before:bg-black before:mt-6 before:-z-10
                        ...
                        <h1
                            className="
                                text-5xl md:text-6xl xl:text-7xl text-black font-['Dela_Gothic_One'] [-webkit-text-stroke:2px_#fff462]
                                before:block before:content-[''] before:absolute before:w-full
                                before:h-9 before:bg-black before:mt-6 before:-z-10
                                after:block after:content-[''] after:absolute after:w-full
                                after:bg-black after:-mt-2 after:-z-10 after:border-solid
                                after:border-t-[12px] after:border-t-black
                                after:border-l-[16px] after:border-l-white
                ...
                <div className="flex flex-col space-y-4 md:space-y-8">
                    ...
                    <div className="flex flex-col justify-center md:flex-row space-y-4 md:space-y-0 md:space-x-52">
                        <Button className="py-6 px-10 md:size-32 transition hover:scale-110" asChild>
                            {/* TODO: スコアのパスを指定する */}
