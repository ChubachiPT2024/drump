...
describe("calculate result", () => {
  test.each([
    // プレイヤー: バスト, ディーラー: バスト
    {
      playersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade)], false),
      dealersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Seven, Suit.Spade), new Card(Rank.Seven, Suit.Spade)], false),
      expected: RoundResult.Loss,
    },
    // プレイヤー: バスト, ディーラー: ブラックジャック
    {
      playersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade)], false),
      dealersHand: new Hand([new Card(Rank.Ace, Suit.Spade), new Card(Rank.Ten, Suit.Spade)], false),
      expected: RoundResult.Loss,
    },
    // プレイヤー: バスト, ディーラー: ブラックジャック以外の 21 以下
    {
      playersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade)], false),
      dealersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade)], true),
      expected: RoundResult.Loss,
    },
    // プレイヤー: ブラックジャック, ディーラー: バスト
    {
      playersHand: new Hand([new Card(Rank.Ace, Suit.Spade), new Card(Rank.Ten, Suit.Spade)], false),
      dealersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade)], false),
    ...
    {
      playersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade)], true),
      dealersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Seven, Suit.Spade), new Card(Rank.Seven, Suit.Spade)], false),
      expected: RoundResult.Win,
    },
    ...
    {
      playersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Ten, Suit.Spade)], true),
      dealersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Nine, Suit.Spade)], true),
      expected: RoundResult.Win,
    },
    // プレイヤー: ブラックジャック以外の 21 以下, ディーラー: ブラックジャック以外の 21 以下, (プレイヤーのトータル) = (ディーラーのトータル)
    {
      playersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Nine, Suit.Spade)], true),
      dealersHand: new Hand([new Card(Rank.Ten, Suit.Spade), new Card(Rank.Nine, Suit.Spade)], true),
      expected: RoundResult.Push,
    },
    // プレイヤー: ブラックジャック以外の 21 以下, ディーラー: ブラックジャック以外の 21 以下, (プレイヤーのトータル) < (ディーラーのトータル)
